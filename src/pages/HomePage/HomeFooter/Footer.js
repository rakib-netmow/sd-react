      ...
      <div class="footer-container">
        ...
        <div class="footer-top">
          <div class="footer-top-content">
            <div class="footer-top-about-info wow animate__ animate__fadeIn animated">
              ...
              <div class="footer-about-text">
                <p>
                  SquadDeck - The ultimate sports team organization and squad
            ...
            <div class="footer-top-single-widget footer-top-widget-1 ">
              <h3 class="">
              ...
              <div class="footer-menu">
                <ul >
                  <li>
                    <a href="https://squaddeck.com/features">Features</a>
                  </li>
                  <li>
                    <a href="https://squaddeck.com/sports">Sports</a>
                  </li>
                  <li>
                    <a href="https://squaddeck.com/about">About us</a>
                  </li>
                  <li>
                    <a href="https://squaddeck.com/pricing">Pricing</a>
                  </li>
                  <li>
                    <a href="https://squaddeck.com/contact">Contact</a>
                  </li>
                </ul>
              </div>
            </div>
            <div class="footer-top-single-widget footer-top-widget-2 ">
              <h3>
                <span>
              ...
              <div class="footer-menu">
                <ul>
                  ...
                  <li>
                    <a href="https://squaddeck.com/features">All Features </a>
                  </li>
                </ul>
              </div>
            </div>
            <div class="footer-top-single-widget footer-top-widget-3 ">
              <h3>
                <span>Help</span>
              </h3>
              <div class="footer-menu">
                <ul>
                  ...
                  <li>
                    <a href="https://squaddeck.com/faq">FAQs</a>
                  </li>
                  <li>
                    <a href="https://squaddeck.com/contact">Contact us</a>
                  </li>
                  <li>
        ...
        <div class="footer-middle">
          ...
          <div class="footer-middle-row">
            <div class="footer-game-list">
              <ul>
                <li>
                  <a href="https://squaddeck.com/sports/basketball-club-management-software">
                    Basketball
                  </a>
                </li>

                <li>
                  <a href="https://squaddeck.com/sports/football-club-management-software">
                    Soccer
                  </a>
                </li>

                <li>
                  <a href="https://squaddeck.com/sports/baseball-club-management-software">
                    Baseball
                  </a>
                </li>

                <li>
                  <a href="https://squaddeck.com/sports/hockey-club-management-software">
                    Hockey
                  </a>
                </li>

                <li>
                  <a href="https://squaddeck.com/sports/rugby-club-management-software">
                    Rugby
                  </a>
                </li>

                <li>
                  <a href="https://squaddeck.com/sports/volleyball-club-management-software">
                    Volleyball
                  </a>
                </li>

                <li>
                  <a href="https://squaddeck.com/sports/cricket-club-management-software">
                    Cricket
                  </a>
                </li>

                <li>
                  <a href="https://squaddeck.com/sports/golf-club-management-software">
                    Golf
                  </a>
                </li>

                <li>
                  <a href="https://squaddeck.com/sports/football-club-and-league-management-software">
                    Football
                  </a>
                </li>

                <li>
                  <a href="https://squaddeck.com/sports/tennis-club-management-software">
                    Tennis
                  </a>
                </li>

                <li>
                  <a href="https://squaddeck.com/sports">All Sports </a>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div class="footer-bottom">
          <div class="footer-bottom-content">
            <div class="footer-bottom-left footer-copyright ">
