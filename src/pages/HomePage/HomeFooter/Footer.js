  ...
  return (
    <div>
      <footer
        ...
        style={{
          backgroundImage:
            "url('https://squaddeck.com/assets/main/img/footer_bg.png')",
        }}
      >
        <div class="footer-shape">
          <img
            src="https://squaddeck.com/assets/main/img/footer-shape.png"
            alt=""
          />
        </div>
        <div class="container">
          <div
            class="footer-cta wow animate__ animate__zoomIn animated"
            style={{ visibility: "visible", animationName: "zoomIn" }}
          >
            <div class="footer-cta-left">
              <div class="icon-wrapper">
                <img
                  src="https://squaddeck.com/assets/main/img/footer_cta_img.png"
                  alt=""
                />
              </div>
            ...
            <div class="footer-cta-right">
              <a
                href="https://squaddeck.com/register"
          ...
          <div class="footer-top">
            <div class="footer-top-content">
              <div
                class="footer-top-about-info wow animate__ animate__fadeIn animated"
                data-wow-delay="0.1s"
                style={{
                  visibility: "visible",
                  animationDelay: "0.1s",
              ...
              >
                <a href="https://squaddeck.com/" class="footer-logo">
                  <img
                    src="https://squaddeck.com/assets/main/img/footer_logo.png"
                    alt=""
                  />
                </a>
                <div
                  class="footer-about-text wow animate__ animate__fadeIn"
                ...
                >
                  <p>
                    ...
                    guardians and players, while driving sales to your
                    merchandise store with one intelligent software platform.
                  </p>
                </div>
              </div>
              <div
                class="footer-top-single-widget footer-top-widget-1 wow animate__ animate__fadeIn animated"
                data-wow-delay="0.5s"
                style={{
                  visibility: "visible",
                  animationDelay: "0.1s",
              ...
              >
                <h3
                  class="wow animate__ animate__fadeIn"
                  style={{ visibility: "visible", animationName: "fadeIn" }}
                >
                ...
                <div class="footer-menu">
                  <ul>
                    <li>
                      <a
                        href="https://squaddeck.com/features"
                        class="wow animate__ animate__fadeIn"
                        style={{
                          visibility: "visible",
                          animationName: "fadeIn",
                    ...
                    <li>
                      <a
                        href="https://squaddeck.com/sports"
                        class="wow animate__ animate__fadeIn"
                        style={{
                          visibility: "visible",
                          animationName: "fadeIn",
                    ...
                    <li>
                      <a
                        href="https://squaddeck.com/about"
                        class="wow animate__ animate__fadeIn"
                        style={{
                          visibility: "visible",
                          animationName: "fadeIn",
                    ...
                    <li>
                      <a
                        href="https://squaddeck.com/pricing"
                        class="wow animate__ animate__fadeIn"
                        style={{
                          visibility: "visible",
                          animationName: "fadeIn",
                    ...
                    <li>
                      <a
                        href="https://squaddeck.com/contact"
                        class="wow animate__ animate__fadeIn"
                        style={{
                          visibility: "visible",
                          animationName: "fadeIn",
              ...
              <div
                class="footer-top-single-widget footer-top-widget-2 wow animate__ animate__fadeIn animated"
                data-wow-delay="1s"
                style={{
                  visibility: "visible",
                  animationDelay: "1s",
              ...
              >
                ...
                <div class="footer-menu">
                  <ul>
                    <li>
                      <a href="https://squaddeck.com/features/sports-club-management-software">
                        Multiple Sports Managment
                      </a>
                    </li>
                    <li>
                      <a href="https://squaddeck.com/features/responsive-websites-with-powerful-cms-system">
                        Custom Website
                      </a>
                    </li>
                    <li>
                      <a href="https://squaddeck.com/features/live-chat-system-for-sports-club">
                        Live Chat
                      </a>
                    </li>
                    <li>
                      <a href="https://squaddeck.com/features/ecommerce-management-for-sports-club">
                        Ecommerce
                      </a>
                    </li>
                    <li>
              ...
              <div
                class="footer-top-single-widget footer-top-widget-3 wow animate__ animate__fadeIn animated"
                data-wow-delay="1.5s"
                style={{
                  visibility: "visible",
                  animationDelay: "1.5s",
                  ...
                  <ul>
                    <li>
                      <a
                        target="_blank"
                        rel="noreferrer"
                        href="https://support.squaddeck.com"
                        class="wow animate__ animate__fadeIn"
                        style={{
                          visibility: "visible",
                          animationName: "fadeIn",
                    ...
                    <li>
                      <a
                        target="_blank"
                        rel="noreferrer"
                        href="https://support.squaddeck.com/submit-ticket/"
                        class="wow animate__ animate__fadeIn"
                        style={{
                          visibility: "visible",
                          animationName: "fadeIn",
          ...
          <div class="footer-middle">
            ...
            <div class="footer-middle-row">
              <div class="footer-game-list">
                <ul>
                  <li>
                    <a
                      href="https://squaddeck.com/sports/basketball-club-management-software"
                  ...
                  <li>
                    <a
                      href="https://squaddeck.com/sports/football-club-management-software"
                      class="wow animate__ animate__fadeIn animated"
                      style={{ visibility: "visible", animationName: "fadeIn" }}
                    >
                      Soccer
                  ...
                  <li>
                    <a
                      href="https://squaddeck.com/sports/baseball-club-management-software"
                      class="wow animate__ animate__fadeIn animated"
                      style={{ visibility: "visible", animationName: "fadeIn" }}
                    >
                      Baseball
                  ...
                  <li>
                    <a
                      href="https://squaddeck.com/sports/hockey-club-management-software"
                      class="wow animate__ animate__fadeIn animated"
                      style={{ visibility: "visible", animationName: "fadeIn" }}
                    >
                      Hockey
                  ...
                  <li>
                    <a
                      href="https://squaddeck.com/sports/rugby-club-management-software"
                      class="wow animate__ animate__fadeIn animated"
                      style={{ visibility: "visible", animationName: "fadeIn" }}
                    >
                      Rugby
                  ...
                  <li>
                    <a
                      href="https://squaddeck.com/sports/volleyball-club-management-software"
                      class="wow animate__ animate__fadeIn animated"
                      style={{ visibility: "visible", animationName: "fadeIn" }}
                    >
                      Volleyball
                  ...
                  <li>
                    <a
                      href="https://squaddeck.com/sports/cricket-club-management-software"
                      class="wow animate__ animate__fadeIn animated"
                      style={{ visibility: "visible", animationName: "fadeIn" }}
                    >
                      Cricket
                  ...
                  <li>
                    <a
                      href="https://squaddeck.com/sports/golf-club-management-software"
                      class="wow animate__ animate__fadeIn animated"
                      style={{ visibility: "visible", animationName: "fadeIn" }}
                    >
                      Golf
                  ...
                  <li>
                    <a
                      href="https://squaddeck.com/sports/football-club-and-league-management-software"
                      class="wow animate__ animate__fadeIn animated"
                      style={{ visibility: "visible", animationName: "fadeIn" }}
                    >
                      Football
                  ...
                  <li>
                    <a
                      href="https://squaddeck.com/sports/tennis-club-management-software"
                      class="wow animate__ animate__fadeIn animated"
                      style={{ visibility: "visible", animationName: "fadeIn" }}
                    >
                      Tennis
            ...
            <div class="footer-middle-row">
              <div
                class="footer-social-links wow animate__ animate__fadeIn animated"
                data-wow-delay="0.1s"
                style={{
                  visibility: "visible",
                  animationDelay: "0.1s",
              ...
              <div
                class="footer-app-links wow animate__ animate__fadeIn animated"
                data-wow-delay=".3s"
                style={{
                  visibility: "visible",
                  animationDelay: "0.3s",
              ...
              >
                ...
                <a href="https://squaddeck.com/app_landing">
                  <img
                    src="https://squaddeck.com/assets/main/img/google-play.png"
                    alt=""
                  />
                </a>
                <a href="https://squaddeck.com/app_landing">
                  <img
                    src="https://squaddeck.com/assets/main/img/appstore.png"
                    alt=""
                  />
                </a>
              </div>
          ...
          <div class="footer-bottom">
            <div class="footer-bottom-content">
              <div
                class="footer-bottom-left footer-copyright wow animate__ animate__fadeIn animated"
                data-wow-delay="1s"
                style={{
                  visibility: "visible",
                  animationDelay: "1s",
              ...
              <div class="footer-bottom-right">
                <div
                  class="footer-bottom-right-nav wow animate__ animate__fadeIn animated"
                  data-wow-delay="1.5s"
                  style={{
                    visibility: "visible",
                    animationDelay: "1.5s",
                ...
                >
                  <a href="https://squaddeck.com/refund-policy">
                    Refund Policy
                  </a>
                  <a href="https://squaddeck.com/privacy_policy">
                    Privacy Policy
                  </a>
                  <a
                    target="_blank"
                    rel="noreferrer"
                    href="https://squaddeck.com/sitemap.xml"
                  >
                    Sitemap
                  </a>
                </div>
...
>
  <div class="footer-shape">
    <img src="https://squaddeck.com/assets/main/img/footer-shape.png" alt="" />
  </div>
  <div class="container">
    <div
      class="footer-cta wow animate__ animate__zoomIn animated"
    ...
    >
      ...
      <div class="footer-cta-right">
        <a href="https://squaddeck.com/register" class="btn-common btn-primary">
          Get Started
        </a>
      </div>
    </div>
    ...
    <div class="footer-bottom">
      <div class="footer-bottom-content">
        ...
        <div class="footer-bottom-right">
          ...
          >
            <a href="https://squaddeck.com/refund-policy">Refund Policy</a>
            <a href="https://squaddeck.com/privacy_policy">Privacy Policy</a>
            <a
              target="_blank"
              rel="noreferrer"
              href="https://squaddeck.com/sitemap.xml"
